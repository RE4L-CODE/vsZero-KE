...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("vs zero", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("vs zero", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "zeroteam";
		app.meta["file"] = "vs zero";
		app.meta["name"] = "vs zero Kade Engine";
		app.meta["packageName"] = "com.zeroteam.kadeengine";
