...
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_448_update,"Stage","update",0x01f9b1d9,"Stage.update","Stage.hx",448,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_472_stepHit,"Stage","stepHit",0x9bf3d897,"Stage.stepHit","Stage.hx",472,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_489_stepHit,"Stage","stepHit",0x9bf3d897,"Stage.stepHit","Stage.hx",489,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_510_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",510,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_542_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",542,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_559_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",559,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_588_lightningStrikeShit,"Stage","lightningStrikeShit",0xc7dd82ec,"Stage.lightningStrikeShit","Stage.hx",588,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_617_trainStart,"Stage","trainStart",0xe162ef4a,"Stage.trainStart","Stage.hx",617,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_628_updateTrainPos,"Stage","updateTrainPos",0xaaf47da5,"Stage.updateTrainPos","Stage.hx",628,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_662_trainReset,"Stage","trainReset",0x441fc4b7,"Stage.trainReset","Stage.hx",662,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_683_resetFastCar,"Stage","resetFastCar",0x5e552099,"Stage.resetFastCar","Stage.hx",683,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_695_fastCarDrive,"Stage","fastCarDrive",0xcd297ee2,"Stage.fastCarDrive","Stage.hx",695,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_705_fastCarDrive,"Stage","fastCarDrive",0xcd297ee2,"Stage.fastCarDrive","Stage.hx",705,0xbcde5ee0)

void Stage_obj::__construct(::String daStage){
            	HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_13_new)
HXLINE( 679)		this->fastCarCanDrive = true;
HXLINE( 624)		this->startedMoving = false;
HXLINE( 612)		this->trainCooldown = 0;
HXLINE( 611)		this->trainFinishing = false;
HXLINE( 610)		this->trainCars = 8;
HXLINE( 608)		this->trainFrameTiming = ((Float)0);
HXLINE( 607)		this->trainMoving = false;
HXLINE( 585)		this->curLight = 0;
HXLINE( 584)		this->lightningOffset = 8;
HXLINE( 583)		this->lightningStrikeBeat = 0;
...
HXLINE( 360)			goto _hx_goto_0;
            		...
            		/* default */{
HXLINE( 416)			this->camZoom = ((Float)0.9);
HXLINE( 417)			this->curStage = HX_("stage",be,6a,0b,84);
HXLINE( 418)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 418)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::loadImage(HX_("stageback",e5,7b,3b,06),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 419)			bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 420)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 421)			bg1->set_active(false);
HXLINE( 422)			this->swagBacks->set(HX_("bg",c5,55,00,00),bg1);
HXLINE( 423)			this->toAdd->push(bg1);
HXLINE( 425)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 425)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::loadImage(HX_("stagefront",2b,fd,b0,c6),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 426)			stageFront1->setGraphicSize(::Std_obj::_hx_int((stageFront1->get_width() * ((Float)1.1))),null());
HXLINE( 427)			stageFront1->updateHitbox();
HXLINE( 428)			stageFront1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 429)			stageFront1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 430)			stageFront1->set_active(false);
HXLINE( 431)			this->swagBacks->set(HX_("stageFront",0b,6d,de,59),stageFront1);
HXLINE( 432)			this->toAdd->push(stageFront1);
HXLINE( 434)			 ::flixel::FlxSprite stageCurtains =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-300,null());
HXDLIN( 434)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::loadImage(HX_("stagecurtains",df,ec,1a,4b),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 435)			stageCurtains1->setGraphicSize(::Std_obj::_hx_int((stageCurtains1->get_width() * ((Float)0.9))),null());
HXLINE( 436)			stageCurtains1->updateHitbox();
HXLINE( 437)			stageCurtains1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 438)			stageCurtains1->scrollFactor->set(((Float)1.3),((Float)1.3));
HXLINE( 439)			stageCurtains1->set_active(false);
HXLINE( 441)			this->swagBacks->set(HX_("stageCurtains",ff,a8,cc,24),stageCurtains1);
HXLINE( 442)			this->toAdd->push(stageCurtains1);
            		}
            		_hx_goto_0:;
            	}
...
void Stage_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_448_update)
HXLINE( 449)		this->super::update(elapsed);
HXLINE( 451)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 453)			if ((this->curStage == HX_("philly",28,77,5e,ef))) {
HXLINE( 456)				if (this->trainMoving) {
HXLINE( 458)					 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 458)					_hx_tmp->trainFrameTiming = (_hx_tmp->trainFrameTiming + elapsed);
HXLINE( 460)					if ((this->trainFrameTiming >= ((Float)0.041666666666666664))) {
HXLINE( 462)						this->updateTrainPos();
HXLINE( 463)						this->trainFrameTiming = ( (Float)(0) );
            					}
            				}
            			}
            		}
...
void Stage_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_472_stepHit)
HXLINE( 473)		this->super::stepHit();
HXLINE( 475)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 477)			::Array< ::Dynamic> array = ( (::Array< ::Dynamic>)(this->slowBacks->get(this->curStep)) );
HXLINE( 478)			bool _hx_tmp;
HXDLIN( 478)			if (::hx::IsNotNull( array )) {
HXLINE( 478)				_hx_tmp = (array->length > 0);
            			}
            			else {
HXLINE( 478)				_hx_tmp = false;
            			}
HXDLIN( 478)			if (_hx_tmp) {
HXLINE( 480)				if (this->hideLastBG) {
HXLINE( 482)					{
HXLINE( 482)						 ::Dynamic bg = this->swagBacks->iterator();
HXDLIN( 482)						while(( (bool)(bg->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 482)							 ::flixel::FlxSprite bg1 = ( ( ::flixel::FlxSprite)(bg->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 484)							if (!(array->contains(bg1))) {
            								HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxSprite,bg1) HXARGC(1)
            								void _hx_run( ::flixel::tweens::FlxTween tween){
            									HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_489_stepHit)
HXLINE( 489)									bg1->set_visible(false);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 486)								 ::flixel::tweens::misc::VarTween tween = ::flixel::tweens::FlxTween_obj::tween(bg1, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 494)					{
HXLINE( 494)						int _g = 0;
HXDLIN( 494)						while((_g < array->length)){
HXLINE( 494)							 ::flixel::FlxSprite bg = array->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 494)							_g = (_g + 1);
HXLINE( 496)							bg->set_visible(true);
HXLINE( 497)							::flixel::tweens::FlxTween_obj::tween(bg, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 502)					int _g = 0;
HXDLIN( 502)					while((_g < array->length)){
HXLINE( 502)						 ::flixel::FlxSprite bg = array->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 502)						_g = (_g + 1);
HXLINE( 503)						bg->set_visible(!(bg->visible));
            					}
            				}
            			}
            		}
...
void Stage_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_510_beatHit)
HXLINE( 511)		this->super::beatHit();
HXLINE( 513)		bool _hx_tmp;
HXDLIN( 513)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 513)			_hx_tmp = (this->animatedBacks->length > 0);
            		}
            		else {
...
HXLINE( 515)			int _g = 0;
HXDLIN( 515)			::Array< ::Dynamic> _g1 = this->animatedBacks;
HXDLIN( 515)			while((_g < _g1->length)){
HXLINE( 515)				 ::flixel::FlxSprite bg = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 515)				_g = (_g + 1);
HXLINE( 516)				bg->animation->play(HX_("idle",14,a7,b3,45),true,null(),null());
            			}
            		}
HXLINE( 519)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 521)			::String _hx_switch_0 = this->curStage;
            			if (  (_hx_switch_0==HX_("halloween",8d,bb,38,50)) ){
HXLINE( 524)				bool _hx_tmp;
HXDLIN( 524)				Float Chance;
HXDLIN( 524)				if ((::Conductor_obj::bpm > 320)) {
HXLINE( 524)					Chance = ( (Float)(100) );
            				}
            				else {
HXLINE( 524)					Chance = ( (Float)(10) );
            				}
HXDLIN( 524)				if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < Chance)) {
HXLINE( 524)					_hx_tmp = (this->curBeat > (this->lightningStrikeBeat + this->lightningOffset));
            				}
            				else {
HXLINE( 524)					_hx_tmp = false;
            				}
HXDLIN( 524)				if (_hx_tmp) {
HXLINE( 526)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 528)						this->lightningStrikeShit();
            					}
            				}
HXLINE( 524)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("limo",1f,17,b3,47)) ){
HXLINE( 538)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            					void _hx_run( ::BackgroundDancer dancer){
            						HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_542_beatHit)
HXLINE( 542)						dancer->dance();
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 540)					( ( ::flixel::group::FlxTypedGroup)(this->swagGroup->get(HX_("grpLimoDancers",70,18,93,51))) )->forEach( ::Dynamic(new _hx_Closure_0()),null());
HXLINE( 545)					bool _hx_tmp;
HXDLIN( 545)					if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 10)) {
HXLINE( 545)						_hx_tmp = this->fastCarCanDrive;
            					}
            					else {
HXLINE( 545)						_hx_tmp = false;
            					}
HXDLIN( 545)					if (_hx_tmp) {
HXLINE( 546)						this->fastCarDrive();
            					}
            				}
HXLINE( 538)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("philly",28,77,5e,ef)) ){
HXLINE( 549)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 551)					if (!(this->trainMoving)) {
HXLINE( 552)						 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 552)						_hx_tmp->trainCooldown = (_hx_tmp->trainCooldown + 1);
            					}
HXLINE( 554)					if ((::hx::Mod(this->curBeat,4) == 0)) {
            						HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            						void _hx_run( ::flixel::FlxSprite light){
            							HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_559_beatHit)
HXLINE( 559)							light->set_visible(false);
            						}
            						HX_END_LOCAL_FUNC1((void))

HXLINE( 556)						 ::flixel::group::FlxTypedGroup phillyCityLights = ( ( ::flixel::group::FlxTypedGroup)(this->swagGroup->get(HX_("phillyCityLights",30,e0,12,1f))) );
HXLINE( 557)						phillyCityLights->forEach( ::Dynamic(new _hx_Closure_1()),null());
HXLINE( 562)						this->curLight = ::flixel::FlxG_obj::random->_hx_int(0,(phillyCityLights->length - 1),null());
HXLINE( 564)						phillyCityLights->members->__get(this->curLight)->__SetField(HX_("visible",72,78,24,a3),true,::hx::paccDynamic);
            					}
            				}
HXLINE( 569)				bool _hx_tmp;
HXDLIN( 569)				bool _hx_tmp1;
HXDLIN( 569)				bool _hx_tmp2;
HXDLIN( 569)				if ((::hx::Mod(this->curBeat,8) == 4)) {
HXLINE( 569)					Float Chance;
HXDLIN( 569)					if ((::Conductor_obj::bpm > 320)) {
HXLINE( 569)						Chance = ( (Float)(150) );
            					}
            					else {
HXLINE( 569)						Chance = ( (Float)(30) );
            					}
HXDLIN( 569)					_hx_tmp2 = (::flixel::FlxG_obj::random->_hx_float(0,100,null()) < Chance);
            				}
            				else {
HXLINE( 569)					_hx_tmp2 = false;
            				}
HXDLIN( 569)				if (_hx_tmp2) {
HXLINE( 569)					_hx_tmp1 = !(this->trainMoving);
            				}
            				else {
HXLINE( 569)					_hx_tmp1 = false;
            				}
HXDLIN( 569)				if (_hx_tmp1) {
HXLINE( 569)					_hx_tmp = (this->trainCooldown > 8);
            				}
            				else {
HXLINE( 569)					_hx_tmp = false;
            				}
HXDLIN( 569)				if (_hx_tmp) {
HXLINE( 571)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 573)						this->trainCooldown = ::flixel::FlxG_obj::random->_hx_int(-4,0,null());
HXLINE( 574)						this->trainStart();
            					}
            				}
HXLINE( 548)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("school",74,b8,c8,40)) ){
HXLINE( 533)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 535)					this->swagBacks->get(HX_("bgGirls",92,16,2b,41))->__Field(HX_("dance",33,83,83,d4),::hx::paccDynamic)();
            				}
HXLINE( 533)				goto _hx_goto_25;
            			}
            			_hx_goto_25:;
            		}
            	}
...
void Stage_obj::lightningStrikeShit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_588_lightningStrikeShit)
HXLINE( 589)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 589)		_hx_tmp->play(::Paths_obj::sound((HX_("thunder_",bb,58,cf,2f) + ::flixel::FlxG_obj::random->_hx_int(1,2,null())),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 590)		 ::Dynamic(this->swagBacks->get(HX_("halloweenBG",92,b2,88,5c))->__Field(HX_("animation",04,ef,34,4b),::hx::paccDynamic))->__Field(HX_("play",f4,2d,5a,4a),::hx::paccDynamic)(HX_("lightning",0a,39,4a,d7));
HXLINE( 592)		this->lightningStrikeBeat = this->curBeat;
HXLINE( 593)		this->lightningOffset = ::flixel::FlxG_obj::random->_hx_int(8,24,null());
HXLINE( 595)		if (::hx::IsNotNull( ::PlayState_obj::boyfriend )) {
HXLINE( 597)			::PlayState_obj::boyfriend->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
HXLINE( 598)			::PlayState_obj::gf->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
            		}
            		else {
HXLINE( 602)			::GameplayCustomizeState_obj::boyfriend->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
HXLINE( 603)			::GameplayCustomizeState_obj::gf->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
            		}
            	}
...
void Stage_obj::trainStart(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_617_trainStart)
HXDLIN( 617)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 619)			this->trainMoving = true;
HXLINE( 620)			this->trainSound->play(true,null(),null());
            		}
            	}
...
void Stage_obj::updateTrainPos(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_628_updateTrainPos)
HXDLIN( 628)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 630)			if ((this->trainSound->_time >= 4700)) {
HXLINE( 632)				this->startedMoving = true;
HXLINE( 634)				if (::hx::IsNotNull( ::PlayState_obj::gf )) {
HXLINE( 635)					::PlayState_obj::gf->playAnim(HX_("hairBlow",b4,c9,39,c9),null(),null(),null());
            				}
            				else {
HXLINE( 637)					::GameplayCustomizeState_obj::gf->playAnim(HX_("hairBlow",b4,c9,39,c9),null(),null(),null());
            				}
            			}
HXLINE( 640)			if (this->startedMoving) {
HXLINE( 642)				 ::Dynamic phillyTrain = this->swagBacks->get(HX_("phillyTrain",80,9b,65,bb));
HXLINE( 643)				 ::Dynamic phillyTrain1 = phillyTrain;
HXDLIN( 643)				phillyTrain1->__SetField(HX_("x",78,00,00,00),( ::Dynamic(phillyTrain1->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) - 400),::hx::paccDynamic);
HXLINE( 645)				bool _hx_tmp;
HXDLIN( 645)				if (::hx::IsLess( phillyTrain->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),-2000 )) {
HXLINE( 645)					_hx_tmp = !(this->trainFinishing);
            				}
            				else {
HXLINE( 645)					_hx_tmp = false;
            				}
HXDLIN( 645)				if (_hx_tmp) {
HXLINE( 647)					phillyTrain->__SetField(HX_("x",78,00,00,00),-1150,::hx::paccDynamic);
HXLINE( 648)					 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 648)					_hx_tmp->trainCars = (_hx_tmp->trainCars - 1);
HXLINE( 650)					if ((this->trainCars <= 0)) {
HXLINE( 651)						this->trainFinishing = true;
            					}
            				}
HXLINE( 654)				bool _hx_tmp1;
HXDLIN( 654)				if (::hx::IsLess( phillyTrain->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),-4000 )) {
HXLINE( 654)					_hx_tmp1 = this->trainFinishing;
            				}
            				else {
HXLINE( 654)					_hx_tmp1 = false;
            				}
HXDLIN( 654)				if (_hx_tmp1) {
HXLINE( 655)					this->trainReset();
            				}
            			}
            		}
            	}
...
void Stage_obj::trainReset(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_662_trainReset)
HXDLIN( 662)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 664)			if (::hx::IsNotNull( ::PlayState_obj::gf )) {
HXLINE( 665)				::PlayState_obj::gf->playAnim(HX_("hairFall",bd,48,d6,cb),null(),null(),null());
            			}
            			else {
HXLINE( 667)				::GameplayCustomizeState_obj::gf->playAnim(HX_("hairFall",bd,48,d6,cb),null(),null(),null());
            			}
HXLINE( 669)			this->swagBacks->get(HX_("phillyTrain",80,9b,65,bb))->__SetField(HX_("x",78,00,00,00),(::flixel::FlxG_obj::width + 200),::hx::paccDynamic);
HXLINE( 670)			this->trainMoving = false;
HXLINE( 673)			this->trainCars = 8;
HXLINE( 674)			this->trainFinishing = false;
HXLINE( 675)			this->startedMoving = false;
            		}
            	}
...
void Stage_obj::resetFastCar(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_683_resetFastCar)
HXDLIN( 683)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 685)			 ::Dynamic fastCar = this->swagBacks->get(HX_("fastCar",d8,f2,1f,de));
HXLINE( 686)			fastCar->__SetField(HX_("x",78,00,00,00),-12600,::hx::paccDynamic);
HXLINE( 687)			fastCar->__SetField(HX_("y",79,00,00,00),::flixel::FlxG_obj::random->_hx_int(140,250,null()),::hx::paccDynamic);
HXLINE( 688)			 ::Dynamic(fastCar->__Field(HX_("velocity",1d,02,fe,1e),::hx::paccDynamic))->__SetField(HX_("x",78,00,00,00),0,::hx::paccDynamic);
HXLINE( 689)			fastCar->__SetField(HX_("visible",72,78,24,a3),false,::hx::paccDynamic);
HXLINE( 690)			this->fastCarCanDrive = true;
            		}
            	}
...
void Stage_obj::fastCarDrive(){
            	HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_695_fastCarDrive)
HXLINE( 694)		 ::Stage _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 696)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
            			...
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_705_fastCarDrive)
HXLINE( 705)				_gthis->resetFastCar();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 698)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 698)			_hx_tmp->play(::Paths_obj::sound((HX_("carPass",05,1f,44,b6) + ::flixel::FlxG_obj::random->_hx_int(0,1,null())),HX_("shared",a5,5e,2b,1d)),((Float)0.7),null(),null(),null(),null());
HXLINE( 700)			this->swagBacks->get(HX_("fastCar",d8,f2,1f,de))->__SetField(HX_("visible",72,78,24,a3),true,::hx::paccDynamic);
HXLINE( 701)			 ::Dynamic _hx_tmp1 = this->swagBacks->get(HX_("fastCar",d8,f2,1f,de));
HXDLIN( 701)			int _hx_tmp2 = ::flixel::FlxG_obj::random->_hx_int(170,220,null());
HXDLIN( 701)			 ::Dynamic(_hx_tmp1->__Field(HX_("velocity",1d,02,fe,1e),::hx::paccDynamic))->__SetField(HX_("x",78,00,00,00),((( (Float)(_hx_tmp2) ) / ::flixel::FlxG_obj::elapsed) * ( (Float)(3) )),::hx::paccDynamic);
HXLINE( 702)			this->fastCarCanDrive = false;
HXLINE( 703)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            		}
            	}
