...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_112_create,"MainMenuState","create",0x6b76e271,"MainMenuState.create","MainMenuState.hx",112,0x0e5db805)
...
HXLINE(  53)		this->clean();
HXLINE(  54)		::PlayState_obj::inDaPlay = false;
HXLINE(  57)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
...
HXDLIN(  62)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
HXLINE(  65)		this->persistentUpdate = (this->persistentDraw = true);
HXLINE(  67)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-100,null(),null());
HXDLIN(  67)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::loadImage(HX_("menuBG",24,65,6d,05),null()),null(),null(),null(),null(),null());
HXLINE(  68)		bg1->scrollFactor->set_x(( (Float)(0) ));
HXLINE(  69)		bg1->scrollFactor->set_y(((Float)0.10));
HXLINE(  70)		bg1->setGraphicSize(::Std_obj::_hx_int((bg1->get_width() * ((Float)1.1))),null());
HXLINE(  71)		bg1->updateHitbox();
HXLINE(  72)		bg1->screenCenter(null());
HXLINE(  73)		bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXDLIN(  79)		this->magenta = _hx_tmp->loadGraphic(::Paths_obj::loadImage(HX_("menuDesat",26,91,04,72),null()),null(),null(),null(),null(),null());
...
HXLINE(  86)		this->magenta->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  87)		this->magenta->set_color(-167525);
HXLINE(  88)		this->add(this->magenta);
HXLINE(  91)		this->menuItems =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  92)		this->add(this->menuItems);
HXLINE(  94)		 ::flixel::graphics::frames::FlxAtlasFrames tex = ::Paths_obj::getSparrowAtlas(HX_("FNF_main_menu_assets",be,dc,57,e2),null(),null());
HXLINE(  96)		{
HXLINE(  96)			int _g = 0;
HXDLIN(  96)			int _g1 = this->optionShit->length;
HXDLIN(  96)			while((_g < _g1)){
HXLINE(  96)				_g = (_g + 1);
HXDLIN(  96)				int i = (_g - 1);
HXLINE(  98)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.6)),null());
HXLINE(  99)				menuItem->set_frames(tex);
HXLINE( 100)				menuItem->animation->addByPrefix(HX_("idle",14,a7,b3,45),(this->optionShit->__get(i) + HX_(" basic",8e,b6,25,79)),24,null(),null(),null());
HXLINE( 101)				menuItem->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),(this->optionShit->__get(i) + HX_(" white",89,d6,28,95)),24,null(),null(),null());
HXLINE( 102)				menuItem->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 103)				menuItem->ID = i;
HXLINE( 104)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 105)				this->menuItems->add(menuItem).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 106)				menuItem->scrollFactor->set(null(),null());
HXLINE( 107)				menuItem->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 108)				if (::MainMenuState_obj::firstStart) {
            					...
            					void _hx_run( ::flixel::tweens::FlxTween flxTween){
            						HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_112_create)
HXLINE( 113)						::MainMenuState_obj::finishedFunnyMove = true;
HXLINE( 114)						_gthis->changeItem(null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 109)					::flixel::tweens::FlxTween_obj::tween(menuItem, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 118)					menuItem->set_y(( (Float)((60 + (i * 160))) ));
            				}
            			}
            		}
HXLINE( 121)		::MainMenuState_obj::firstStart = false;
HXLINE( 123)		::flixel::FlxG_obj::camera->follow(this->camFollow,null(),(((Float)0.60) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))));
HXLINE( 125)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 18),0,::MainMenuState_obj::gameVer,12,null());
HXLINE( 126)		versionShit->scrollFactor->set(null(),null());
HXLINE( 127)		versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 128)		this->add(versionShit);
HXLINE( 132)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXLINE( 133)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),true);
            		}
            		else {
HXLINE( 135)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Duo(true),true);
            		}
HXLINE( 137)		this->changeItem(null());
...
HXLINE( 146)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 148)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 148)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 151)		if (!(this->selectedSomethin)) {
HXLINE( 153)			 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->lastActive;
...
HXDLIN( 169)			if (_this->keyManager->checkStatus(38,_this->status)) {
...
HXLINE( 175)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 175)			if (_this1->keyManager->checkStatus(40,_this1->status)) {
...
HXLINE( 190)					this->fancyOpenURL(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
...
HXLINE( 257)			 ::flixel::FlxState nextState =  ::OptionsDirect_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 282)			spr->animation->_curAnim->set_frameRate((( (Float)(24) ) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))));
...
HXDLIN(  42)		kadeEngineVer = (HX_("1.8",bb,56,25,00) + ::MainMenuState_obj::nightly);
            	}
{
