...
HX_DEFINE_STACK_FRAME(_hx_pos_f5d92c5178b43db3_27_new,"KadeEngineFPS","new",0x1590e882,"KadeEngineFPS.new","KadeEngineFPS.hx",27,0x99ed1d2e)
HX_LOCAL_STACK_FRAME(_hx_pos_f5d92c5178b43db3_87___enterFrame,"KadeEngineFPS","__enterFrame",0x9b2752b3,"KadeEngineFPS.__enterFrame","KadeEngineFPS.hx",87,0x99ed1d2e)
HX_LOCAL_STACK_FRAME(_hx_pos_f5d92c5178b43db3_82_boot,"KadeEngineFPS","boot",0xc15389d0,"KadeEngineFPS.boot","KadeEngineFPS.hx",82,0x99ed1d2e)

void KadeEngineFPS_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_color){
            		Float x = __o_x.Default(10);
            		Float y = __o_y.Default(10);
            		int color = __o_color.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_f5d92c5178b43db3_27_new)
...
HXLINE(  52)		{
HXLINE(  52)			 ::KadeEngineFPS _g = ::hx::ObjectPtr<OBJ_>(this);
...
Dynamic KadeEngineFPS_obj::__CreateEmpty() { return new KadeEngineFPS_obj; }

void *KadeEngineFPS_obj::_hx_vtable = 0;

Dynamic KadeEngineFPS_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< KadeEngineFPS_obj > _hx_result = new KadeEngineFPS_obj();
	_hx_result->__construct(inArgs[0],inArgs[1],inArgs[2]);
	return _hx_result;
}

bool KadeEngineFPS_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x27dd54d0) {
		if (inClassId<=(int)0x0c89e854) {
			...
			return inClassId==(int)0x27dd54d0;
		}
	} else {
...
void KadeEngineFPS_obj::_hx___enterFrame(int _tmp_deltaTime){
            	HX_STACKFRAME(&_hx_pos_f5d92c5178b43db3_87___enterFrame)
...
HXLINE(  91)				if ((::KadeEngineFPS_obj::currentColor >= this->array->length)) {
HXLINE(  92)					::KadeEngineFPS_obj::currentColor = 0;
            				}
HXLINE(  93)				::KadeEngineFPS_obj::currentColor = ::Math_obj::round(((( (Float)(this->skippedFrames) ) / (( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ) / ( (Float)(3) ))) * ( (Float)(this->array->length) )));
HXLINE(  94)				 ::Main _hx_tmp = ::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0));
HXDLIN(  94)				_hx_tmp->changeFPSColor(this->array->__get(::KadeEngineFPS_obj::currentColor));
HXLINE(  95)				::KadeEngineFPS_obj::currentColor++;
...
HXLINE( 101)		 ::KadeEngineFPS _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 116)					_hx_tmp1 = ((HX_("\nKE ",7c,47,d5,06) + HX_("v",76,00,00,00)) + ::MainMenuState_obj::kadeEngineVer);
            				}
            				else {
...
HXLINE( 114)					_hx_tmp = ((HX_("KE ",46,25,39,00) + HX_("v",76,00,00,00)) + ::MainMenuState_obj::kadeEngineVer);
            				}
            				else {
...
int KadeEngineFPS_obj::currentColor;


::hx::ObjectPtr< KadeEngineFPS_obj > KadeEngineFPS_obj::__new(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_color) {
	::hx::ObjectPtr< KadeEngineFPS_obj > __this = new KadeEngineFPS_obj();
	__this->__construct(__o_x,__o_y,__o_color);
	return __this;
}

::hx::ObjectPtr< KadeEngineFPS_obj > KadeEngineFPS_obj::__alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_color) {
	KadeEngineFPS_obj *__this = (KadeEngineFPS_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(KadeEngineFPS_obj), true, "KadeEngineFPS"));
	*(void **)__this = KadeEngineFPS_obj::_hx_vtable;
	__this->__construct(__o_x,__o_y,__o_color);
	return __this;
}

KadeEngineFPS_obj::KadeEngineFPS_obj()
{
}

void KadeEngineFPS_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(KadeEngineFPS);
...
void KadeEngineFPS_obj::__Visit(HX_VISIT_PARAMS)
{
...
::hx::Val KadeEngineFPS_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
bool KadeEngineFPS_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
::hx::Val KadeEngineFPS_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
...
bool KadeEngineFPS_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
void KadeEngineFPS_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo KadeEngineFPS_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(KadeEngineFPS_obj,currentFPS),HX_("currentFPS",30,71,28,c7)},
	{::hx::fsObject /*  ::openfl::display::Bitmap */ ,(int)offsetof(KadeEngineFPS_obj,bitmap),HX_("bitmap",ef,0f,0c,f1)},
	{::hx::fsInt,(int)offsetof(KadeEngineFPS_obj,cacheCount),HX_("cacheCount",2d,ab,1b,8d)},
	{::hx::fsFloat,(int)offsetof(KadeEngineFPS_obj,currentTime),HX_("currentTime",e6,a4,8e,85)},
	{::hx::fsObject /* ::Array< Float > */ ,(int)offsetof(KadeEngineFPS_obj,times),HX_("times",c6,bf,35,10)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(KadeEngineFPS_obj,array),HX_("array",99,6d,8f,25)},
	{::hx::fsInt,(int)offsetof(KadeEngineFPS_obj,skippedFrames),HX_("skippedFrames",76,1f,4b,c6)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo KadeEngineFPS_obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &KadeEngineFPS_obj::currentColor,HX_("currentColor",6a,56,68,91)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif

static ::String KadeEngineFPS_obj_sMemberFields[] = {
...
static void KadeEngineFPS_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(KadeEngineFPS_obj::currentColor,"currentColor");
};

#ifdef HXCPP_VISIT_ALLOCS
static void KadeEngineFPS_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(KadeEngineFPS_obj::currentColor,"currentColor");
};

#endif

::hx::Class KadeEngineFPS_obj::__mClass;

static ::String KadeEngineFPS_obj_sStaticFields[] = {
	HX_("currentColor",6a,56,68,91),
	::String(null())
};

void KadeEngineFPS_obj::__register()
{
	KadeEngineFPS_obj _hx_dummy;
	KadeEngineFPS_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("KadeEngineFPS",90,3f,96,4b);
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &KadeEngineFPS_obj::__GetStatic;
	__mClass->mSetStaticField = &KadeEngineFPS_obj::__SetStatic;
	__mClass->mMarkFunc = KadeEngineFPS_obj_sMarkStatics;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(KadeEngineFPS_obj_sStaticFields);
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(KadeEngineFPS_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< KadeEngineFPS_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = KadeEngineFPS_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = KadeEngineFPS_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = KadeEngineFPS_obj_sStaticStorageInfo;
#endif
	::hx::_hx_RegisterClass(__mClass->mName, __mClass);
}

void KadeEngineFPS_obj::__boot()
{
{
            	HX_STACKFRAME(&_hx_pos_f5d92c5178b43db3_82_boot)
