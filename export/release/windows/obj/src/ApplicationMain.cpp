...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("vs zero",eb,da,b2,e3),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("13",e2,2a,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("zeroteam",c5,7b,25,75));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("vs zero",eb,da,b2,e3));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("vs zero Kade Engine",76,39,8f,c9));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.zeroteam.kadeengine",f5,ba,5c,03));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("vs zero Kade Engine",76,39,8f,c9))
...
HXLINE(  99)		app->createWindow(attributes);
