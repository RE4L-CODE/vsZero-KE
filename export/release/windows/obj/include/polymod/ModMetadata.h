...
HX_DECLARE_STACK_FRAME(_hx_pos_bf85bbb123aa7472_483_new)
...
class HXCPP_CLASS_ATTRIBUTES ModMetadata_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ModMetadata_obj > __new() {
			::hx::ObjectPtr< ModMetadata_obj > __this = new ModMetadata_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ModMetadata_obj > __alloc(::hx::Ctx *_hx_ctx) {
