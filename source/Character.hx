...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'zerokung':
				frames = Paths.getSparrowAtlas('zerokung/Zerokung');
				animation.addByPrefix('idle', 'zerokung idle', 24, false);
				animation.addByPrefix('singUP', 'zerokung up note', 24, false);
				animation.addByPrefix('singDOWN', 'zerokung down note', 24, false);
				animation.addByPrefix('singLEFT', 'zerokung left note', 24, false);
				animation.addByPrefix('singRIGHT', 'zerokung right note', 24, false);

				addOffset('idle', 0, 150);
				addOffset('singUP', 0, 150);
				addOffset('singDOWN', 0, 100);
				addOffset('singLEFT', 0, 150);
				addOffset('singRIGHT', 0, 150);
